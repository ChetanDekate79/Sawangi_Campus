...
const Bar_graph = () => {
  ...
  categoryAxis.renderer.labels.template.fontSize = 12; // Set the desired font size for x-labels
  ...
  return (
    ...
    <div style={{ display: "flex",  marginBottom: "10px",marginTop: "2vh",marginLeft: "2vw" }}>
      ...
      <label htmlFor="select_host" style={{ marginRight: '10px', fontWeight: 'bold' }}>
        Select Host:
      </label>
      <select
        id="select_host"
...
<div style={{ marginBottom: "10px", display: "flex", alignItems: "center", marginRight: "10px"  }}>
  ...
  />
      ...
      {isLoadingData ? ( 
        ...
        <div id="chartdiv" style={{ width: '92vw', height: "75vh"}} />
      )}
    </div>
    </div>
